<template>
  <q-page padding class="dash">
    <q-list class="row absolute-top-left absolute-bottom-right">
      <q-item
        v-for="(model, moduleName) in renderEntities"
        :key="moduleName"
        :to="model.route"
        class="dash__element col-1 col-xl-2 col-lg-2 col-md-3 col-sm-4 col-xs-12 bg-grey-8"
        :class="{ 'dash__element--mobile': $q.platform.is.mobile }"
